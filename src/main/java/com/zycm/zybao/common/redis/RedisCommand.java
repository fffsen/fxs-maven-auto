package com.zycm.zybao.common.redis;
...
public interface RedisCommand<K, V> {
    ...
    Set<K> getAllKeys();
    /**
    * @Title: getAllKeysPrefix
    * @Description: 根据前缀匹配key
    * @param prefix
    * @return    参数
    * @author sy
    * @throws
    ...
    *
    */
    Set<String> getAllKeysPrefix(String prefix);
    /**
    * @Title: getAllKeysSuffix
    * @Description: 根据后缀匹配key
    * @param suffix
    * @return    参数
    * @author sy
    * @throws
    ...
    *
    */
    Set<String> getAllKeysSuffix(String suffix);
    /**
     * 获取所有的普通key-value
     * @return
     */

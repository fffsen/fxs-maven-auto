...
public class ZipUtil {
    ...
    public static void zip(String srcPath, String zipPath, String zipFileName) throws Exception
    {
        ...
        {
            throw new Exception("压缩成zip的参数不能为空!");
        }
        ...
        try
        {
            ...
            {
                throw new Exception("压缩文件保存的路径不能是源文件路径的子文件夹，避免无限递归压缩！");
            }
    ...
    public static void unzip(String zipFilePath, String unzipFilePath, boolean includeZipFileName) throws Exception
    {
        ...
        {
            throw new Exception("解压缩zip时参数不能为空!");
        }
        File zipFile = new File(zipFilePath);
    ...
    {
        String zipPath = "C:\\Users\\Administrator\\materialRepository\\zip";
        String dir = "C:\\Users\\Administrator\\materialRepository\\zip\\ProgExport";
